...
- `public/` is a plain monospace page: a block-character ball (`░▒▓█`) generated in `app.js` as a shaded sphere, which shakes, swirls, and reveals the reply inside a triangle, and a bar chart of Jev's full probability distribution over the 20 replies. No frameworks.
